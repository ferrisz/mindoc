...
#RUN mkdir -p /go/src/github.com/lifei6671/ && cd /go/src/github.com/lifei6671/ && git clone https://github.com/ferrisz/mindoc.git && cd mindoc

ADD . /go/src/github.com/ferrisz/mindoc

WORKDIR /go/src/github.com/ferrisz/mindoc
...
ADD start.sh /go/src/github.com/ferrisz/mindoc
...
COPY --from=build /go/src/github.com/ferrisz/mindoc /mindoc
